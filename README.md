...
git clone https://github.com/tonnymuchui/TDD-Project.git <Your-Build-Directory>
...
Feel free to check the [issues page](https://github.com/TechnoAndy/TDD_project_ruby/issues).
